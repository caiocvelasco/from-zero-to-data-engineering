...
Agora que os dados estão limpos e os relatórios são atualizados automaticamente, o próximo passo é reagir enquanto as coisas acontecem - ver uma venda no momento em que ela ocorre e ajustar campanhas instantaneamente. É o que chamamos de engenharia de dados em tempo real.
-> _Kafka é o **mensageiro**, e PySpark é o **motor**_.

O engenheiro de dados implementa orquestração e streaming, permitindo que:  
- Novas vendas sejam processadas assim que chegam da API, relatórios sejam atualizados automaticamente (`Airflow DAGs`), e alertas sejam disparados quando houver anomalias.
